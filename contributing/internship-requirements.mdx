...
<Steps>
  <Step title="Search the README">
    Check the [main README](https://github.com/vanshb03/Summer2026-Internships) for the company and role
  </Step>
  
  <Step title="Search Open Issues">
    Look through [open issues](https://github.com/vanshb03/Summer2026-Internships/issues) to see if someone else already submitted it
  </Step>
  
  <Step title="Check Recently Closed Issues">
    Review [recently closed issues](https://github.com/vanshb03/Summer2026-Internships/issues?q=is%3Aissue+is%3Aclosed) in case it was just added
  </Step>
</Steps>
...
If you notice an internship that's no longer accepting applications, you can help keep the list current by using the [Close Internship template](https://github.com/vanshb03/Summer2026-Internships/issues/new/choose).
